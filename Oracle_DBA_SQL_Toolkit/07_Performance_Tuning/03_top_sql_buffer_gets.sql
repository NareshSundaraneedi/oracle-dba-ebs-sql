--------------------------------------------------------------------------------
-- File Name       : 03_top_sql_buffer_gets.sql
-- Category        : 07_Performance_Tuning
-- Purpose         : Top SQL by buffer gets (logical I/O)
-- Oracle Version  : 19c
...
--------------------------------------------------------------------------------
-- DESCRIPTION
-- Ranks cursors in GV$SQL by buffer gets. This is since the cursor
...
-- strictly ordered by buffer gets so you do not mix units.
--
...
--------------------------------------------------------------------------------
-- QUERY 1: Top SQL by buffer gets
--------------------------------------------------------------------------------
-- 1. What the query does
--    Selects from GV$SQL ordered by buffer_gets.
-- 2. Important columns
--    SQL_ID, BUFFER_GETS, GETS_PER_EXEC, PLAN_HASH_VALUE, MODULE, SQL_TEXT.
...
PROMPT
PROMPT === End of query: Top SQL by buffer gets ===
PROMPT
