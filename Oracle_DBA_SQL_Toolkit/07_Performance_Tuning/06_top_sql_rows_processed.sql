--------------------------------------------------------------------------------
-- File Name       : 06_top_sql_rows_processed.sql
-- Category        : 07_Performance_Tuning
-- Purpose         : Top SQL by rows processed
-- Oracle Version  : 19c
...
--------------------------------------------------------------------------------
-- DESCRIPTION
-- Ranks cursors in GV$SQL by rows processed. This is since the cursor
...
-- strictly ordered by rows processed so you do not mix units.
--
...
--------------------------------------------------------------------------------
-- QUERY 1: Top SQL by rows processed
--------------------------------------------------------------------------------
-- 1. What the query does
--    Selects from GV$SQL ordered by rows_processed.
-- 2. Important columns
--    SQL_ID, ROWS_PROCESSED, PLAN_HASH_VALUE, MODULE, SQL_TEXT.
...
PROMPT
PROMPT === End of query: Top SQL by rows processed ===
PROMPT
